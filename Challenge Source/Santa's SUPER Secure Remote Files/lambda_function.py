...
def lambda_handler(event, context):
    ...
    if path == "/":
        return {
            ...
            "body": ("After the recent data breaches, Santa has decided to get rid"
                     " of Rupert, and instead hire his twin, Rupelf. Rupelf has a"
                     " a keen eye for security and definitely won't let anything slip!"
