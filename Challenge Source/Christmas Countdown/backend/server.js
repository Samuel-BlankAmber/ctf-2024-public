...
const SANTA_PW = crypto.randomBytes(64).toString('hex');
const SANTA_FAV_NUMBER = crypto.randomBytes(8).readBigInt64BE(0);

const users = {
    santa: {
        password: SANTA_PW,
        resetPasswordQuestion: "What is your favourite 64-bit number?",
        resetPasswordAnswer: SANTA_FAV_NUMBER.toString(),
    },
};
